...
describe('BindingsIndexUndef', () => {
  ...
  describe('with allowDisjointDomains false', () => {
    describe('without keys', () => {
      beforeEach(() => {
        index = new BindingsIndexUndef([], hashFn, false);
      });
    ...
    describe('with one key', () => {
      ...
      describe('with one bindings', () => {
        ...
        it('should getFirst variable, null or undefined terms with matchUndefsAsWildcard false', () => {
          expect(index.getFirst(BF.bindings(), false)).toBeUndefined();
          expect(index.getFirst(BF.bindings([
            [ DF.variable('a'), DF.variable('b') ],
          ]), false)).toBeUndefined();
        });
  ...
  describe('with allowDisjointDomains true', () => {
    describe('without keys', () => {
      beforeEach(() => {
        index = new BindingsIndexUndef([], hashFn, true);
      });
    ...
    describe('with one key', () => {
      ...
      describe('with one bindings', () => {
        ...
        it('should get variable, null or undefined terms', () => {
          expect(index.get(BF.bindings())).toEqual([ 1 ]);
          expect(index.get(BF.bindings([
            [ DF.variable('a'), DF.variable('b') ],
          ]))).toEqual([ 1 ]);
        });
        ...
        it('should getFirst variable, null or undefined terms', () => {
          expect(index.getFirst(BF.bindings())).toBe(1);
          expect(index.getFirst(BF.bindings([
            [ DF.variable('a'), DF.variable('b') ],
          ]))).toBe(1);
        });
    ...
    describe('with three keys', () => {
      ...
      describe('with three bindings', () => {
        ...
        it('should get variable, null or undefined terms', () => {
          expect(index.get(BF.bindings())).toEqual([ 1, 2, 3 ]);
          expect(index.get(BF.bindings([
            [ DF.variable('a'), DF.variable('b') ],
            [ DF.variable('b'), DF.variable('b') ],
            [ DF.variable('c'), DF.variable('b') ],
    ...
    describe('with two keys', () => {
      ...
      describe('with mixed bindings', () => {
        ...
        it('should get variable, null or undefined terms', () => {
          expect(index.get(BF.bindings())).toEqual([ 1, 2, 3, 4, 5 ]);
          expect(index.get(BF.bindings([
            [ DF.variable('a'), DF.variable('b') ],
            [ DF.variable('b'), DF.variable('b') ],
          ]))).toEqual([ 1, 2, 3, 4, 5 ]);
    ...
    describe('with three keys and one extra key', () => {
      ...
      describe('values', () => {
        it('should return all values', () => {
          expect(index.values()).toEqual([ 1, 2, 3, 4 ]);
        });
      });
