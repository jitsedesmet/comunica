import { ActorExpressionEvaluatorFactoryDefault } from '@comunica/actor-expression-evaluator-factory-default/lib';
...
export function getMockMediatorExpressionEvaluatorFactory(
  ...
  return <any>{
    ...
    mediate: async(arg: any) => getMockEEFactory(args).run(arg, undefined),
  };
}
