...
describe('We should respect the strdt03 spec', () => {
  ...
  runFuncTestTable({
    ...
    `,
    errorTable: `
      '${n1}' xsd:string = 'Argument types not valid for operator'
      '${n2}' xsd:string = 'Argument types not valid for operator'
      '${n3}' xsd:string = 'Argument types not valid for operator'
      '${n4}' xsd:string = 'Argument types not valid for operator'
      '${n5}' xsd:string = 'Argument types not valid for operator'
  
      '${s2}' xsd:string = 'Argument types not valid for operator'
  
      '${d1}' xsd:string = 'Argument types not valid for operator'
      '${d2}' xsd:string = 'Argument types not valid for operator'
      '${d3}' xsd:string = 'Argument types not valid for operator'
      '${d4}' xsd:string = 'Argument types not valid for operator'
    `,
  });
});
