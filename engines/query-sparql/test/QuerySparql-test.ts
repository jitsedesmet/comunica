    ...
    describe('simple SPO on a raw RDF document', () => {
      ...
      describe('extension function', () => {
        ...
        it('rejects when record does not match', async() => {
          ...
          await expect(engine.query(baseQuery('nonExist'), context)).rejects
            .toThrow('Query operation processing failed: none of the configured actors were able to handle the operation type filter');
        });
